...
var (
	pkg       = flag.String("assert-path", "github.com/pjdufour-truss/testify/assert", "Path to the assert package")
...
var headerTemplate = `/*
* CODE GENERATED AUTOMATICALLY WITH github.com/pjdufour-truss/testify/_codegen
